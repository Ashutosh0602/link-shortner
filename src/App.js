...
function App() {
  ...
  const submit = (e) => {
    e.preventDefault();
    //   fetch("http://localhost:3005/link", {
    //     method: "POST",
    //     mode: "no-cors",
    //     headers: {
    ...
    //     },
    //     body: JSON.stringify({ a: "ashutosh" }),
    //   })
    //     .then((res) => res.json())
      ...
      <div className="input_area">
        <form method="POST" action="/link">
          <input
            ...
            name="input"
          />
          <button onSubmit={(e) => e.preventDefault()}>Short URL</button>
        </form>
      ...
      <div>
        <div className="waves">
          <svg
            ...
            className=".path_0 transition duration-300 ease-in-out delay-150"
          >
            <defs>
